...
At [promoted-go-delivery-client-example](https://github.com/promotedai/promoted-go-delivery-client-example).
...
`useCase` | delivery.UseCase | Yes | One of the use case enum values or strings, i.e. 'UseCase_FEED', 'UseCase_SEARCH', etc.
